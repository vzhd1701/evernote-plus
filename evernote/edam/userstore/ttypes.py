...
class PublicUserInfo(object):
    ...
    def __init__(self, userId: int = None, serviceLevel: typing.Optional[evernote.edam.type.ttypes.ServiceLevel] = None, username: typing.Optional[str] = None, noteStoreUrl: typing.Optional[str] = None, webApiUrlPrefix: typing.Optional[str] = None,):
...
class GetNAPAccessJWTRequest(object):
    """
    Attributes:
    ...
    def __init__(self, includeBusinessFields: typing.Optional[bool] = None,):
        self.includeBusinessFields: typing.Optional[bool] = includeBusinessFields
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.BOOL:
                    self.includeBusinessFields = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('GetNAPAccessJWTRequest')
        if self.includeBusinessFields is not None:
            oprot.writeFieldBegin('includeBusinessFields', TType.BOOL, 1)
            oprot.writeBool(self.includeBusinessFields)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
all_structs.append(GetNAPAccessJWTRequest)

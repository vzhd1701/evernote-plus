...
class SyncChunk(object):
    ...
    def __init__(self, currentTime: int = None, chunkHighUSN: typing.Optional[int] = None, updateCount: int = None, notes: typing.Optional[list[evernote.edam.type.ttypes.Note]] = None, notebooks: typing.Optional[list[evernote.edam.type.ttypes.Notebook]] = None, tags: typing.Optional[list[evernote.edam.type.ttypes.Tag]] = None, searches: typing.Optional[list[evernote.edam.type.ttypes.SavedSearch]] = None, resources: typing.Optional[list[evernote.edam.type.ttypes.Resource]] = None, expungedNotes: typing.Optional[list[str]] = None, expungedNotebooks: typing.Optional[list[str]] = None, expungedTags: typing.Optional[list[str]] = None, expungedSearches: typing.Optional[list[str]] = None, linkedNotebooks: typing.Optional[list[evernote.edam.type.ttypes.LinkedNotebook]] = None, expungedLinkedNotebooks: typing.Optional[list[str]] = None,):
        self.currentTime: int = currentTime
        self.chunkHighUSN: typing.Optional[int] = chunkHighUSN
        self.updateCount: int = updateCount
        self.notes: typing.Optional[list[evernote.edam.type.ttypes.Note]] = notes
        self.notebooks: typing.Optional[list[evernote.edam.type.ttypes.Notebook]] = notebooks
        self.tags: typing.Optional[list[evernote.edam.type.ttypes.Tag]] = tags
        self.searches: typing.Optional[list[evernote.edam.type.ttypes.SavedSearch]] = searches
        self.resources: typing.Optional[list[evernote.edam.type.ttypes.Resource]] = resources
        ...
        self.linkedNotebooks: typing.Optional[list[evernote.edam.type.ttypes.LinkedNotebook]] = linkedNotebooks
...
class NoteList(object):
    ...
    def __init__(self, startIndex: int = None, totalNotes: int = None, notes: list[evernote.edam.type.ttypes.Note] = None, stoppedWords: typing.Optional[list[str]] = None, searchedWords: typing.Optional[list[str]] = None, updateCount: typing.Optional[int] = None, searchContextBytes: typing.Optional[bytes] = None, debugInfo: typing.Optional[str] = None,):
        self.startIndex: int = startIndex
        self.totalNotes: int = totalNotes
        self.notes: list[evernote.edam.type.ttypes.Note] = notes
...
class NoteMetadata(object):
    ...
    def __init__(self, guid: str = None, title: typing.Optional[str] = None, contentLength: typing.Optional[int] = None, created: typing.Optional[int] = None, updated: typing.Optional[int] = None, deleted: typing.Optional[int] = None, updateSequenceNum: typing.Optional[int] = None, notebookGuid: typing.Optional[str] = None, tagGuids: typing.Optional[list[str]] = None, attributes: typing.Optional[evernote.edam.type.ttypes.NoteAttributes] = None, largestResourceMime: typing.Optional[str] = None, largestResourceSize: typing.Optional[int] = None,):
        self.guid: str = guid
        ...
        self.notebookGuid: typing.Optional[str] = notebookGuid
        self.tagGuids: typing.Optional[list[str]] = tagGuids
        self.attributes: typing.Optional[evernote.edam.type.ttypes.NoteAttributes] = attributes
...
class NoteEmailParameters(object):
    ...
    def __init__(self, guid: typing.Optional[str] = None, note: typing.Optional[evernote.edam.type.ttypes.Note] = None, toAddresses: typing.Optional[list[str]] = None, ccAddresses: typing.Optional[list[str]] = None, subject: typing.Optional[str] = None, message: typing.Optional[str] = None,):
...
class RelatedResult(object):
    ...
    def __init__(self, notes: typing.Optional[list[evernote.edam.type.ttypes.Note]] = None, notebooks: typing.Optional[list[evernote.edam.type.ttypes.Notebook]] = None, tags: typing.Optional[list[evernote.edam.type.ttypes.Tag]] = None, containingNotebooks: typing.Optional[list[evernote.edam.type.ttypes.NotebookDescriptor]] = None, debugInfo: typing.Optional[str] = None, experts: typing.Optional[list[evernote.edam.type.ttypes.UserProfile]] = None, relatedContent: typing.Optional[list[evernote.edam.type.ttypes.RelatedContent]] = None, cacheKey: typing.Optional[str] = None, cacheExpires: typing.Optional[int] = None,):
        self.notes: typing.Optional[list[evernote.edam.type.ttypes.Note]] = notes
        self.notebooks: typing.Optional[list[evernote.edam.type.ttypes.Notebook]] = notebooks
        self.tags: typing.Optional[list[evernote.edam.type.ttypes.Tag]] = tags
        self.containingNotebooks: typing.Optional[list[evernote.edam.type.ttypes.NotebookDescriptor]] = containingNotebooks
        self.debugInfo: typing.Optional[str] = debugInfo
        self.experts: typing.Optional[list[evernote.edam.type.ttypes.UserProfile]] = experts
        self.relatedContent: typing.Optional[list[evernote.edam.type.ttypes.RelatedContent]] = relatedContent
        self.cacheKey: typing.Optional[str] = cacheKey
...
class RelatedResultSpec(object):
    ...
    def __init__(self, maxNotes: typing.Optional[int] = None, maxNotebooks: typing.Optional[int] = None, maxTags: typing.Optional[int] = None, writableNotebooksOnly: typing.Optional[bool] = None, includeContainingNotebooks: typing.Optional[bool] = None, includeDebugInfo: typing.Optional[bool] = None, maxExperts: typing.Optional[int] = None, maxRelatedContent: typing.Optional[int] = None, relatedContentTypes: typing.Optional[set[evernote.edam.type.ttypes.RelatedContentType]] = None,):
        ...
        self.relatedContentTypes: typing.Optional[set[evernote.edam.type.ttypes.RelatedContentType]] = relatedContentTypes
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i218 in range(_size214):
                        _elem219 = evernote.edam.type.ttypes.RelatedContentType(iprot.readI32())
...
class UpdateNoteIfUsnMatchesResult(object):
    ...
    def __init__(self, note: typing.Optional[evernote.edam.type.ttypes.Note] = None, updated: typing.Optional[bool] = None,):
        self.note: typing.Optional[evernote.edam.type.ttypes.Note] = note
...
class InvitationShareRelationship(object):
    ...
    def __init__(self, displayName: typing.Optional[str] = None, recipientUserIdentity: typing.Optional[evernote.edam.type.ttypes.UserIdentity] = None, privilege: typing.Optional[ShareRelationshipPrivilegeLevel] = None, sharerUserId: typing.Optional[int] = None,):
        self.displayName: typing.Optional[str] = displayName
        self.recipientUserIdentity: typing.Optional[evernote.edam.type.ttypes.UserIdentity] = recipientUserIdentity
...
class ManageNotebookSharesParameters(object):
    ...
    def __init__(self, notebookGuid: typing.Optional[str] = None, inviteMessage: typing.Optional[str] = None, membershipsToUpdate: typing.Optional[list[MemberShareRelationship]] = None, invitationsToCreateOrUpdate: typing.Optional[list[InvitationShareRelationship]] = None, unshares: typing.Optional[list[evernote.edam.type.ttypes.UserIdentity]] = None,):
        self.notebookGuid: typing.Optional[str] = notebookGuid
        ...
        self.unshares: typing.Optional[list[evernote.edam.type.ttypes.UserIdentity]] = unshares
...
class ManageNotebookSharesError(object):
    ...
    def __init__(self, userIdentity: typing.Optional[evernote.edam.type.ttypes.UserIdentity] = None, userException: typing.Optional[evernote.edam.error.ttypes.EDAMUserException] = None, notFoundException: typing.Optional[evernote.edam.error.ttypes.EDAMNotFoundException] = None,):
        self.userIdentity: typing.Optional[evernote.edam.type.ttypes.UserIdentity] = userIdentity
...
class SharedNoteTemplate(object):
    ...
    def __init__(self, noteGuid: typing.Optional[str] = None, recipientThreadId: typing.Optional[int] = None, recipientContacts: typing.Optional[list[evernote.edam.type.ttypes.Contact]] = None, privilege: typing.Optional[evernote.edam.type.ttypes.SharedNotePrivilegeLevel] = None,):
        self.noteGuid: typing.Optional[str] = noteGuid
        self.recipientThreadId: typing.Optional[int] = recipientThreadId
        self.recipientContacts: typing.Optional[list[evernote.edam.type.ttypes.Contact]] = recipientContacts
        self.privilege: typing.Optional[evernote.edam.type.ttypes.SharedNotePrivilegeLevel] = privilege

    def __setattr__(self, name, value):
        if name == "privilege":
            super().__setattr__(name, value if hasattr(value, 'value') else evernote.edam.type.ttypes.SharedNotePrivilegeLevel.__members__.get(value))
            return
        super().__setattr__(name, value)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.privilege = evernote.edam.type.ttypes.SharedNotePrivilegeLevel(iprot.readI32())
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
class NotebookShareTemplate(object):
    ...
    def __init__(self, notebookGuid: typing.Optional[str] = None, recipientThreadId: typing.Optional[int] = None, recipientContacts: typing.Optional[list[evernote.edam.type.ttypes.Contact]] = None, privilege: typing.Optional[evernote.edam.type.ttypes.SharedNotebookPrivilegeLevel] = None,):
        self.notebookGuid: typing.Optional[str] = notebookGuid
        self.recipientThreadId: typing.Optional[int] = recipientThreadId
        self.recipientContacts: typing.Optional[list[evernote.edam.type.ttypes.Contact]] = recipientContacts
        self.privilege: typing.Optional[evernote.edam.type.ttypes.SharedNotebookPrivilegeLevel] = privilege

    def __setattr__(self, name, value):
        if name == "privilege":
            super().__setattr__(name, value if hasattr(value, 'value') else evernote.edam.type.ttypes.SharedNotebookPrivilegeLevel.__members__.get(value))
            return
        super().__setattr__(name, value)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.privilege = evernote.edam.type.ttypes.SharedNotebookPrivilegeLevel(iprot.readI32())
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
class CreateOrUpdateNotebookSharesResult(object):
    ...
    def __init__(self, updateSequenceNum: typing.Optional[int] = None, matchingShares: typing.Optional[list[evernote.edam.type.ttypes.SharedNotebook]] = None,):
        self.updateSequenceNum: typing.Optional[int] = updateSequenceNum
        self.matchingShares: typing.Optional[list[evernote.edam.type.ttypes.SharedNotebook]] = matchingShares
...
class NoteMemberShareRelationship(object):
    ...
    def __init__(self, displayName: typing.Optional[str] = None, recipientUserId: typing.Optional[int] = None, privilege: typing.Optional[evernote.edam.type.ttypes.SharedNotePrivilegeLevel] = None, restrictions: typing.Optional[NoteShareRelationshipRestrictions] = None, sharerUserId: typing.Optional[int] = None,):
        self.displayName: typing.Optional[str] = displayName
        self.recipientUserId: typing.Optional[int] = recipientUserId
        self.privilege: typing.Optional[evernote.edam.type.ttypes.SharedNotePrivilegeLevel] = privilege
...
class NoteInvitationShareRelationship(object):
    ...
    def __init__(self, displayName: typing.Optional[str] = None, recipientIdentityId: typing.Optional[int] = None, privilege: typing.Optional[evernote.edam.type.ttypes.SharedNotePrivilegeLevel] = None, sharerUserId: typing.Optional[int] = None,):
        self.displayName: typing.Optional[str] = displayName
...
class ManageNoteSharesError(object):
    ...
    def __init__(self, identityID: typing.Optional[int] = None, userID: typing.Optional[int] = None, userException: typing.Optional[evernote.edam.error.ttypes.EDAMUserException] = None, notFoundException: typing.Optional[evernote.edam.error.ttypes.EDAMNotFoundException] = None,):
